...
--
-- Servidor: localhost
-- Tiempo de generación: 11-08-2022 a las 06:12:56
...
(31, 'prueba', 'prueba', 'prueba@gmail.com', '1', 2),
(32, 'danna', 'sastoque', 'danna@gmail.com', '1', 2);
...
CREATE TABLE `venta_temporal` (
  `Id_venta_Temp` int(11) NOT NULL,
  `New_Cantidad_Temp` varchar(20) NOT NULL,
...
--
-- Volcado de datos para la tabla `venta_temporal`
--

INSERT INTO `venta_temporal` (`Id_venta_Temp`, `New_Cantidad_Temp`, `Precio_Final`, `Id_Producto`, `Id_User`) VALUES
(8, '4', '100', 1, 0),
(9, '3', '75000', 2, 25),
(10, '1', '25000', 2, 0),
(11, '2', '50000', 2, 0),
...
--
ALTER TABLE `venta_temporal`
  MODIFY `Id_venta_Temp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
-- Filtros para la tabla `venta_temporal`
--
ALTER TABLE `venta_temporal`
  ADD CONSTRAINT `venta_temporal_ibfk_1` FOREIGN KEY (`Id_Producto`) REFERENCES `productos` (`Id_Producto`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;

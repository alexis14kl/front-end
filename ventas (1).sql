...
--
-- Servidor: localhost
-- Tiempo de generación: 09-08-2022 a las 11:55:12
...
INSERT INTO `venta_temporal` (`Id_venta_Temp`, `New_Cantidad_Temp`, `Precio_Final`, `Id_Producto`) VALUES
(7, '1', '25', 1),
(8, '4', '100', 1),
(9, '3', '75000', 2),
(10, '1', '25000', 2),
...
--
ALTER TABLE `venta_temporal`
  MODIFY `Id_venta_Temp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

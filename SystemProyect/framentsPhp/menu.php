     ...
     <div class="sidebar">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    <li class="active">
                        <a href="indexClientes.php">Home</a>
                    </li>
                    <li>
    ...
    <header>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                    <div class="full">
                        <a style="font-size: 35pt;" class="logo" href="MisPedidos.php"><p style="color: red;" id="ventaAgregada"></p> <i class="fa fa-cart-arrow-down" aria-hidden="true"></i>
